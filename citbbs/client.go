...
const (
	...
	userAgent      = "citbbs-go/" + libraryVersion
)
...
// Client encapsulates a client that talks to the citbbs API
type Client struct {
	// client represents the HTTP client used for making HTTP requests.
	client *http.Client

	// UserAgent is the version of the citbbs-go library that is being used
	UserAgent string
...
// WithAccessToken configures a client with the given citbbs access token.
...
// WithServiceToken configures a client with the given citbbs Service Token
...
// WithHTTPClient configures the citbbs client with the given HTTP client.
...
// NewClient instantiates an instance of the citbbs API client.
