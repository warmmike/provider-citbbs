...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider citbbs CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider citbbs controllers
...
# This target prepares repo for your provider by replacing all "citbbs"
